...
function askForRDV(timestamp, skey){
	...
	//ajaxCall("ajax_form_status", ajaxCall("ajax_form_status", "https://dz2fr.tlscontact.com/dz/ORN/action.php?process=multiconfirm&what=book_appointment&fg_id=5633953&result="+event.target.innerText+"&issuer_view=dzORN2fr");
